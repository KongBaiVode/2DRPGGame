...
{
    public Player2WallSlideState(Player2 _player, Player2StateMachine _stateMachine, string _animBoolName) : base(_player, _stateMachine, _animBoolName)
    {
    }
    ...
    private void HandleWallSlide()
    {
        if(yInput < 0)
            ...
            rb.velocity = new Vector2(0, rb.velocity.y * player.wallSlideMultiplier);
    }
}
