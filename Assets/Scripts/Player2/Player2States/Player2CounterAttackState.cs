...
public class Player2CounterAttackState : Player2State
{
    public Player2CounterAttackState(Player2 _player, Player2StateMachine _stateMachine, string _animBoolName) : base(_player, _stateMachine, _animBoolName)
    {
    }
